# Generated by Django 3.2 on 2023-05-22 15:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+\\Z', message='Буквы, цифры и символы @/./+/-/_'), reviews.validators.validate_username])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveIntegerField(error_messages={'validators': 'Оценка от 1 до 10!'}, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='оценка')),
